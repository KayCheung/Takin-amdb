...
public class TraceDaoImpl implements ITraceDao, ApplicationContextAware, InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        switch (datasource.toLowerCase()) {
            case "mysql":
                ...
                break;
            case "clickhouse":
                createtSetClickhouseJdbcTemplate();
                break;
            default:
    ...
    private void createtSetClickhouseJdbcTemplate() {

        String clickhouseUrl = applicationContext.getEnvironment().getProperty("config.clickhouse.url");
        String clickhouseUserName = applicationContext.getEnvironment().getProperty("config.clickhouse.username");
        String clickhousePassword = applicationContext.getEnvironment().getProperty("config.clickhouse.password");
