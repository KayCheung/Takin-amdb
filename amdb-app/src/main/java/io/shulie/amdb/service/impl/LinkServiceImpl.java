...
public class LinkServiceImpl implements LinkService {
    ...
    private Pair<List<TAmdbPradarLinkNodeDO>, List<TAmdbPradarLinkEdgeDO>> getPradarLinkInfoFromTrace(String linkId,
        ...
        try {
            org.apache.commons.lang3.tuple.Pair<Set<LinkNodeModel>, Set<LinkEdgeModel>> topology = linkProcessService
                    .getLinkProcessor().link(linkId, linkConfig, TraceLogQueryScopeEnum.build(60));
